              ...
              <Stack direction='column' spacing={4} align='center'>
                ...
                <FormControl mt={4}>
                  <Stack
                    ...
                    <Checkbox type="checkbox" name="remember" onChange={ handleChangeFormData } checked={formData.remember}>Remember me</Checkbox>
                ...
                <Flex fontSize='sm' mt='50px'>
                  ...
                  <Link as={ReactLink} color='green'>Join now</Link>
                </Flex>
              </Stack>
            </form>
          </ModalBody>
